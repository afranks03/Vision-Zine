  ...
  return (
    <div className="vz-container vz-section">
      ...
      <p className="vz-prose mt-3 max-w-2xl">
        Style sets the typographic personality of the zine. Format sets the physical size of
        the printed copy. Both swap instantly without losing any of the content you write.
      </p>
